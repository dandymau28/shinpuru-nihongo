...
export const STR = {
  ...
  conj_level: { en: "Level", id: "Tingkat" },
  conj_forms: { en: "Forms to practise", id: "Bentuk yang dilatih" },
  conj_presets: { en: "Presets", id: "Prasetel" },
  conj_session_mode: { en: "Session", id: "Sesi" },
  ...
  conj_weak_none: {
    en: "Do a few rounds and your weakest forms will show up here.",
    id: "Lakukan beberapa putaran dan bentuk terlemahmu akan muncul di sini.",
  },
